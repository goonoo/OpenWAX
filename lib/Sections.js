...
var getLabel = function(element) {
    ...
    var labelElement, labelChilds, i;
  ...
  return {
    header: (function() {
      ...
      $foldBtn.onclick = function() {
        ...
        // fix bug: IE8 won't reflow when set data-* attribute
        rdoc.body.className = rdoc.body.className;
      };
    ...
    sections: {
      ...
      pageLang: new ListSection(
        ...
        function(doc, url) {
          ...
          if (url.substr(0,4).toLowerCase() !== 'http') {
            return false;
          } else if (isXhtml && this.getAttribute('xml:lang') && this.getAttribute('lang')) {
      ...
      validation: new ToolSection(
        ...
        function(win, rdoc) {
          var isChromeAddon = typeof chrome !== "undefined" && chrome.extension;
          var isFirefoxAddon = typeof Components !== "undefined" && Components.classes;
